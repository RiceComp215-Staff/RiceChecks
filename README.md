...
- Loads `edu.rice.ricechecks:ricechecks-annotations:0.8.0` (just the Java annotations)
  as a regular dependency for student code.
  
- Loads `edu.rice.ricechecks:ricechecks:0.8.0` (the autograder tool) as part of
