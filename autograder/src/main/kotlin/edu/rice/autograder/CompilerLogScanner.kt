...
val javacLogMissing = CodeStyleDeduction("Compiler: Can't find output",
    0.0, TAG, "", false, 0, 0)
...
fun javacZeroWarnings(fileData: String): CodeStyleDeduction {
    ...
    val result =
        if (fileData.isEmpty() || lines.isEmpty())
            CodeStyleDeduction("Compiler: No warnings or errors",
                0.0, TAG, "", true, 0, 0)
        else
            CodeStyleDeduction("Compiler: One or more warnings / errors",
                0.0, TAG, "", false, 0, 0)
